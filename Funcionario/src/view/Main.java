	...
	public static void main(String[] args) {
		...
		case 1: 
			...
			case 1:
				...
				Funcionarios d = new Docente(cpf, siape, nome, dataAdm, titulo, area, salarioBase);
				rh.adicionaFuncionario(d);
				break;
			case 2:
				sc.nextLine();
				
				//(String cpf,String siape, String nome, String dataAdmissao, int titulo, String setor,double salarioBase)
				...
				Funcionarios t = new Tecnico(cpf, siape, nome, dataAdm, titulo, setor, salarioBase);
			...
			case 3:
				...
				Funcionarios tr = new Terceirizado(cpf, nome, dataAdm,dataFim, titulo, area, salarioBase);
